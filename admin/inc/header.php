...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light border-bottom p-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="/recipe-php/assets/images/icons/pie.png" alt="pie icon" id="site-logo" class="bg-white"/> <span class="text-light">Recipie</span></a>
