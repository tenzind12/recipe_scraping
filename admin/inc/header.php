...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light border-bottom p-4">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="index.php"><img src="/recipe-php/assets/images/icons/pie.png" alt="pie icon" style="width:25px" class="bg-white rounded"/> Recipie</a>
