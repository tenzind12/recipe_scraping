...
<?php $db = new ConnectionDB();
    ...
    if($all_recipes) {
        ...
        // END PAGINATION
        ?>
            <h2 class="text-center my-5 admin-pages__title display-4 text-darkblue"><img src="../assets/images/icons/recipe.png" alt="recipe-list icon" style="width: 70px;">&nbsp; The recipe list</h2>
